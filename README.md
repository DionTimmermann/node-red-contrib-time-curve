...
![Alt text](https://raw.githubusercontent.com/DionTimmermann/node-red-contrib-time-curve/master/images/flow.png)
...
![Alt text](https://raw.githubusercontent.com/DionTimmermann/node-red-contrib-time-curve/master/images/edit.png)

## Attribution
This node is based on the [spline-curve node by Jason Cronquist](https://flows.nodered.org/node/node-red-contrib-spline-curve).